...
export const QuizView = ({
  ...
  return (
    <div className="fixed inset-0 w-full bg-background flex flex-col" style={{ paddingTop: 0, marginTop: 0 }}>
      <QuizTimer
      ...
      <div className="flex-1 overflow-y-auto">
        <div className={`${isMobile ? 'p-2 pt-4' : 'p-4 pt-6'} flex flex-col ${isMobile ? 'gap-4' : 'gap-6'} max-w-4xl mx-auto w-full`}>
          <QuizProgress
